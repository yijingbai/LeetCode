...
I did not solve this problem by myself. Cited from https://leetcode.com/problems/divide-two-integers/
There is a very nice solution with detailed explantation:
```
