 ...
 * Ri ≤ INT_MAX, 0 , and Ri - Li > 0. You may assume all buildings are perfect 
 ...
 * the left endpoint of a horizontal line segment. Note that the last key point, where 
 * the rightmost building ends, is merely used to mark the termination of the skyline, 
